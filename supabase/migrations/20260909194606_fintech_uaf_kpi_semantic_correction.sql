...
begin
  ...
  payload := payload || jsonb_build_object(
    'uaf_perimeter', jsonb_build_object(
      ...
      'method_note','El KPI UAF del panorama representa el perímetro registral relevante para el estudio Fintech. La inscripción UAF por sí sola no convierte automáticamente a una entidad de Otras Entidades Facultadas para Recibir Moneda Extranjera en fintech confirmada.'
    )
  );
