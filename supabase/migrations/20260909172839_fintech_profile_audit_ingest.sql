  ...
  loop
    ...
    if r->>'subject_type'='CANDIDATE' then
      ...
      insert into public.aml_fintech_profile_audit(
        ...
        r->>'subject_key',coalesce(r->>'classifier_version','unknown'),r->>'business_model_hint',nullif(r->>'business_model_confidence','')::numeric,
        r->>'target_customer_hint',nullif(r->>'target_customer_confidence','')::numeric,r->>'revenue_model_hint',nullif(r->>'revenue_model_confidence','')::numeric,
